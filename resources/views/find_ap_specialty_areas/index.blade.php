<?php
view()->share('pageTitle', __('Find Ap Specialty Areas'));
view()->share('hideSubHeader', true);
?>
<x-base-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('find-ap-specialty-areas.index') }}
    @endsection
    @push('firstStyles')
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Find Ap Specialty Area') }}" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('find-ap-specialty-areas.create') }}" class="btn btn-primary">
                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr075.svg", "svg-icon-2") !!}
                        {{ __('New Find Ap Specialty Area') }}
                    </a>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["find_ap_specialty_areas-table"], {
                    buttons: [
                        'export',
                    ]
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#find_ap_specialty_areas-table').DataTable().draw(false);
                        });
                    }
                });
            }
