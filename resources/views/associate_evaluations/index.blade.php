<?php
view()->share('pageTitle', __('Associate Evaluations'));
view()->share('hideSubHeader', true);
?>
<x-base-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('associate-evaluations.index') }}
    @endsection
    @push('firstStyles')
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Associate Evaluation') }}" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('associate-evaluations.create') }}" class="btn btn-primary">
                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr075.svg", "svg-icon-2") !!}
                        {{ __('New Associate Evaluation') }}
                    </a>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["associate_evaluations-table"], {
                    buttons: [
                        'export',
                    ]
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#associate_evaluations-table').DataTable().draw(false);
                        });
                    }
                });
            }
