...
# A sua quota encontra-se a aguardar pagamento

Efetue o pagamento das suas quotas para continuar como sócio ativo.<br>
...
Ou clique <a href="{{route('home')}}"> aqui</a> para ver no site os dados de pagamento.<br>
