<!-- Associate Id Field -->
<div class="mb-10">
    {!! Form::label('associate_id', $declarationQuestion->getAttributeLabel('associate_id'), ['class' => 'form-label']) !!}
...
<div class="mb-10">
    {!! Form::label('declaration_template_id', $declarationQuestion->getAttributeLabel('declaration_template_id'), ['class' => 'form-label']) !!}
...
<div class="mb-10">
    {!! Form::label('declaration_number', $declarationQuestion->getAttributeLabel('declaration_number'), ['class' => 'form-label']) !!}
    {!! Form::number('declaration_number', null, ['class' => 'form-control form-control-solid '.($errors->has('declaration_number') ? 'is-invalid' : '')]) !!}
...
<!-- Status Field -->
<div class="mb-10">
    {!! Form::label('status', $declarationQuestion->getAttributeLabel('status'), ['class' => 'form-label']) !!}
...
<!-- Emited At Field -->
<div class="mb-10">
    {!! Form::label('emited_at', $declarationQuestion->getAttributeLabel('emited_at'), ['class' => 'form-label']) !!}
    <div class="position-relative d-flex align-items-center">
        ...
        <!--begin::Datepicker-->
        {!! Form::text('emited_at', null, ['class' => 'form-control form-control-solid ps-12 '.($errors->has('emited_at') ? 'is-invalid' : ''), 'placeholder' => __('Pick a date') ]) !!}
        <!--end::Datepicker-->
    </div>
    @error('emited_at')
        <div class="invalid-feedback">{{ $message }}</div>
