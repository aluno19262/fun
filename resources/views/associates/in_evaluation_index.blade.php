<?php
view()->share('pageTitle', __('Associates in Evaluation'));
view()->share('hideSubHeader', true);
?>
<x-base-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('associates.in_evaluation_index') }}
    @endsection
    @push('firstStyles')
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Associate') }}" />
                </div>
                <!--end::Search-->
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["associates-in-evaluation-table"], {
                    buttons: [
                        'export',
                    ]
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#associates-in-evaluation-table').DataTable().draw(false);
                        });
                    }
                });
            }
