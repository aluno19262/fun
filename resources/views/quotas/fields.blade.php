<!-- Associate Id Field -->
<div class="mb-10">
    {!! Form::label('associate_id', $quota->getAttributeLabel('associate_id'), ['class' => 'form-label']) !!}
...
<!-- Year Field -->
<div class="mb-10">
    {!! Form::label('year', $quota->getAttributeLabel('year'), ['class' => 'form-label']) !!}
    <div class="position-relative d-flex align-items-center">
        ...
        <!--begin::Datepicker-->
        {!! Form::text('year', null, ['class' => 'form-control form-control-solid ps-12 '.($errors->has('year') ? 'is-invalid' : ''), 'placeholder' => __('Pick a date') ]) !!}
        <!--end::Datepicker-->
    </div>
    @error('year')
        <div class="invalid-feedback">{{ $message }}</div>
...
<!-- Semester Field -->
<div class="mb-10">
    {!! Form::label('semester', $quota->getAttributeLabel('semester'), ['class' => 'form-label']) !!}
    {!! Form::number('semester', null, ['class' => 'form-control form-control-solid '.($errors->has('semester') ? 'is-invalid' : '')]) !!}
    @error('semester')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-10">
    {!! Form::label('payment_limit_date', $quota->getAttributeLabel('payment_limit_date'), ['class' => 'form-label']) !!}
    <div class="position-relative d-flex align-items-center">
        <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
        <span class="svg-icon svg-icon-2 position-absolute mx-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<!-- Price Field -->
<div class="mb-10">
    {!! Form::label('price', $quota->getAttributeLabel('price'), ['class' => 'form-label']) !!}
...
<!-- Status Field -->
<div class="mb-10">
    {!! Form::label('status', $quota->getAttributeLabel('status'), ['class' => 'form-label']) !!}
