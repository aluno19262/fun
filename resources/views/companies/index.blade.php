<?php
view()->share('pageTitle', __('Companies'));
        ...
        <div class="card-header">
            {{--<div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Company') }}" />
                </div>
                <!--end::Search-->
            </div>--}}
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["companies-table"], {
                    buttons: [
                        'export',
                    ]
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#companies-table').DataTable().draw(false);
                        });
                    }
                });
            }
