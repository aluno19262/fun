<?php
view()->share('pageTitle', __('Declarations Waiting Approval'));
view()->share('hideSubHeader', true);
?>
<x-base-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('declarations.waiting_approval') }}
    @endsection
    @push('firstStyles')
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["declarations-waiting-approval-table"], {
                    buttons: [
                        'export',
                    ]
                }).container().appendTo($('#datatable-buttons'));
                handleSearchDatatable(window.LaravelDataTables["declarations-waiting-approval-table"]);
            });
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#declarations-waiting-approval-table').DataTable().draw(false);
                        });
                    }
                });
            }
