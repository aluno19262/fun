...
return [
    ...
    'custom' => [
        ...
        'vat' => [
          'unique' => "O valor indicado para o campo NIF já se encontra registado.",
          'required' => "O valor indicado para o campo NIF é obrigatório.",
        ],
        'order_vat' => [
            'required' => "É obrigatória a indicação de um valor para o campo NIF."
        ],
        'previous_declaration_number' =>[
            'required_if' => "É obrigatória a indicação de um valor para o campo :attribute quando o valor do campo :other foi selecionado."
        ]
    ],
    'attributes' => [],
    "invalidBI" => "Não é um B.I. válido.",
    "invalidNIF" => "Não é um NIF válido.",
    "invalidCC" => "Não é um CC válido.",
];
