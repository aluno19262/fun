...
class CompanyDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($company) {
                return '<a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('companies.show', $company) .'" title="'. __('View') .'">'. theme()->getSvgIcon("icons/duotune/general/gen004.svg", "svg-icon-2") .'</a>
                        <a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('companies.edit', $company) .'" title="'. __('Edit') .'">'. theme()->getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-2") .'</a>
                        <button class="btn btn-sm btn-bg-light btn-color-primary btn-icon delete-confirmation" data-destroy-form-id="destroy-form-'. $company->id .'" data-delete-url="'. route('companies.destroy', $company) .'" onclick="destroyConfirmation(this)" title="'. __('Delete') .'">'. theme()->getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-2") .'</button>';
            })
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            Column::make('zip')->title($model->getAttributeLabel('zip')),
            Column::make('location')->title($model->getAttributeLabel('location')),
            Column::make('parish')->title($model->getAttributeLabel('parish')),
            Column::make('municipality')->title($model->getAttributeLabel('municipality')),
