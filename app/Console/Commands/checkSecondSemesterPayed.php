...
class checkSecondSemesterPayed extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'quotas:check_second_semester_payed';
    ...
    public function handle()
    {
        ...
        $quotaEndDate = Carbon::createFromFormat('d-m-Y','31-07-' . $year);
        ...
        foreach ($associates as $associate){
            if(Carbon::today()->day == 15 && Carbon::today()->month == 6){
                //create a new quota
            ...
            if(Carbon::today()->day == 15 && Carbon::today()->month == 7){
            ...
            if(Carbon::today()->day == 1 && Carbon::today()->month == 8){
                echo " no dia \n";
