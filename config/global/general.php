...
return array(
    ...
    'product' => array(
        'name'        => 'Noop',
        'description' => 'Noop - Laravel Starter V2 with Metronic 8',
        'preview'     => '',
        'purchase'    => '',
    ...
    // Meta
    'meta'    => array(
        'title'       => 'Noop - Laravel Starter V2 with Metronic 8',
        'description' => 'Noop - Laravel Starter V2 with Metronic 8',
    ...
    'general' => array(
        ...
        'about'               => 'https://noop.pt',
        'contact'             => 'mailto:dev@noop.pt',
        'support'             => 'https:/noop.pt/contacto',
